...
export default function About2() {
  ...
  return (
    <>
      <section className="bgPattern relative shadow-xl overflow-x-hidden">
        <section className="cointainer m-auto w-[90%] min-h-[700px] flex justify-center items-center md:py-56 relative">
          ...
          <section className="flex flex-col justify-center items-center mt-4 md:mt-36 max-w-[900px]">
            <div className="w-[300px] h-[300px] rounded-full mt-[60%] bg-gray-100 flex items-center justify-center md:mt-8">
              <span>minha foto </span>
            </div>
            <p className="mt-16 lg:mt-24 text-gray-800 text-center text-lg md:text-xl">
