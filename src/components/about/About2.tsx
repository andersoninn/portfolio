      ...
      <section className="bgAbout -mt-72 relative overflow-x-hidden">
        <section className="cointainer m-auto w-[90%] min-h-[700px] flex justify-center items-center md:pt-56 md:pb-12">
          ...
          <Image
            ...
            width={400}
            height={400}
            className="absolute top-10 animate__animated animate__fadeInUp"
          />
          <motion.div
            id="helloo"
            ref={ref}
            className="absolute top-52 text-7xl md:text-[200px] font-bold text-white flex"
          >
            {text.split('').map((letter, index) => (
              <motion.span
                key={index}
          ...
          <section className="flex mt-44 flex-col justify-center items-center md:mt-36 max-w-[900px]">
            <div className="w-[250px] h-[250px] rounded-full mt-44 bg-gray-100 flex items-center justify-center md:mt-2">
              <span>minha foto </span>
            </div>
            <p className="mt-12 lg:mt-24 text-white text-center text-lg md:text-xl">
              {texts.decription}
            </p>
            <article className="w-full flex flex-col justify-end items-end mt-16 text-lg">
              {/* <motion.div
