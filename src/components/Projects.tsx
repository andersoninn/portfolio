          ...
          <section className="p-5 bg-brand-gray100 rounded-lg flex flex-col gap-3 shadow-md max-w-[450px]">
            ...
            <article className="text-center text-lg">
              ...
              <p className="pt-2">
                ...
                coding. Highlights technical skills and commitment to delivering
                practical solutions for real-world challenges, ensuring engaging
          ...
          <section className="p-5 bg-brand-gray100 rounded-lg flex flex-col gap-3 shadow-md max-w-[450px]">
            ...
            <article className="text-center text-lg">
              ...
              <p className="pt-2">
                ...
                portfolio for diverse, well-executed coding projects, showcasing
                technical skills and practical solutions for real-world
                challenges.
              </p>
            </article>
            <aside className="flex justify-end">
        ...
        <aside className="mt-10 flex m-auto justify-between w-full">
          <section className="flex-col gap-2">
            <article className="flex gap-2">
              ...
              <p className="text-brand-blueTitle font-bold text-2xl">+1</p>
            </article>
