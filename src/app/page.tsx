...
export default function Page() {
  return (
    <section className="bg-[url('../assets/image/home/homeBg.svg')] bg-no-repeat bg-left-bottom">
        ...
        <section className="container m-auto flex px-24">
          ...
          <article className="w-1/2">
            ...
            <p className="pl-2">
              ...
              Portugal. Committed to growth, eager to contribute and enhance my
              skills with a new team.
            </p>
