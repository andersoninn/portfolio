        ...
        <section className="pt-10 container m-auto flex gap-12 max-w-[1180px] px-24">
          <article className="relative w-full flex">
            <Image
              ...
              height="235"
              alt=""
              className="-translate-x-1/2 -translate-y-[178px]"
            />
            <Image
              src={AboutMePicture}
              width={600}
              alt=""
              className="rounded-md z-10 -translate-x-[170px]"
            />
          </article>
          <article className="w-full">
            <h2 className="text-brand-blue100 font-bold">About Me</h2>
            <h1 className="text-brand-blueTitle text-4xl font-black">
              <span className="-ml-5">“Discipline love and courage</span> are
              the motors of success”
            </h1>
            <p className="pt-2 pr-8 text-balance">
              As a former military professional, I excelled as the Secretary to
              the Director of Aircraft, securing the second position in my
              class. I made significant contributions in the Special Infantry
              Battalion of Galeão, leading critical peacekeeping missions and
              implementing operational regulations that continue to endure.
              Opting for a move to Portugal in pursuit of a life away from
              violence marked a significant turning point. Currently, I am
              dedicatedly studying programming to ensure a successful career
              transition, showcasing my commitment to promising challenges and
              continuous growth.
            </p>
